...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self):
    ...
    tpose = move_group.get_current_pose()
    print type(tpose)
    print tpose
    ...
    pose_goal.orientation.w = 0.877548662774
    pose_goal.orientation.y = 1.0
    pose_goal.orientation.x = 0.0
    pose_goal.orientation.z = 0.0

    
    # move_group.go(tpose,wait = True)
...
def main():
  try:
    ...
    print("============ Press `Enter` to execute a movement using a pose goal for middle group...")
    raw_input()
